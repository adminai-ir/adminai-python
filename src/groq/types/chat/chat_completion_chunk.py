...
class Xadminai(BaseModel):
    id: Optional[str]
    """
    A adminai request ID which can be used by to refer to a specific request to adminai support 
...
class ChatCompletionChunk(BaseModel):
    ...
    x_adminai: Optional[Xadminai]
    """
    Additional metadata provided by adminai.
    """
